package rs.edu.raf.banka1.unit;
...
import rs.edu.raf.banka1.service.UserServiceImpl;
...
public class UserServiceUnitTests {
    ...
    void testGetUser() {
        ...
        try {
            // KORAK 3: Pozivamo metodu koju zelimo da testiramo.
            UserDto dto = userService.getUser("Test");

            // KORAK 4: Proveramo da li smo dobili ocekivani rezultat.
            assertEquals(dto.getUsername(), user1.getUsername());
            assertEquals(dto.getImePrezime(), user1.getImePrezime());
            assertEquals(dto.getIsAdmin(), user1.getIsAdmin());
        } catch (Exception e) {
